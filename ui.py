...
##                return
        ...
        if affectedRow == 0:
            ...
            addYesBtn=Button(windowFill, text="Yes", font=("Helvetica",15), bg="#75d179",command=newItemWindow).place(x=100,y=220)
...
def onClickTake():
    ...
    ##                return
        ...
        if affectedRow == 0:
            ...
            addYesBtn=Button(windowTake, text="Yes",command=newItemWindow, font=("Helvetica",15), bg="#75d179").place(x=100,y=220)
